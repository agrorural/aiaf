...
<?php }else{?>
  	<div class="masshead" style="background: url('<?php echo $default_masshead_uri; ?>')  no-repeat top left; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
<?php } ?>
	<div class="container">
